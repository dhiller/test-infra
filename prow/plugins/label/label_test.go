...
func TestLabel(t *testing.T) {
	...
	testcases := []testCase{
		...
		{
			name:                  "Add custom label good-first-issue",
			body:                  "/label good-first-issue",
			extraLabels:           []string{"good-first-issue"},
			repoLabels:            []string{"good-first-issue"},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels("good-first-issue"),
			expectedRemovedLabels: []string{},
			commenter:             orgMember,
			action:                github.GenericCommentActionCreated,
		},
